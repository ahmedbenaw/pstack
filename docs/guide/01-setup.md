...
[`/setup-pstack`](../../skills/setup-pstack/SKILL.md) detects the models you have access to, shows you each role (code delegates, judgment, the review panels), and asks what you want. Answer the questions. It writes `~/.pstack/models.md` (or `~/.cursor/rules/pstack-models.mdc` on Cursor), a small rule every pstack skill reads.
