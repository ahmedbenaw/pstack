...
Before spawning investigators, list the MCP servers available in this session, from the tools you can actually call. Use the available-tools map when the host provides one. On Cursor the `mcps/` directory also enumerates enabled servers.
